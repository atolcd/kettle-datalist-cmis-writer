...
public class CMISDLWStepMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() throws KettleValueException {
    ...
    for (int i = 0; i < fieldOrder.length; i++) {
      ...
      retval.append("        ").append(XMLHandler.addTagValue("order", i)); //$NON-NLS-1$ //$NON-NLS-2$
      retval.append("        ").append(XMLHandler.addTagValue("name", fieldOrder[i])); //$NON-NLS-1$ //$NON-NLS-2$
      retval.append("      </field>").append(Const.CR); //$NON-NLS-1$
    }
    ...
    for (int i = 0; i < repositories.length; i++) {
      ...
      retval.append("        ")
          .append(XMLHandler.addTagValue("order", i));
      retval.append("        ").append(
          XMLHandler.addTagValue("name", repositories[i]));
      retval.append("      </repos>").append(Const.CR);
    }
    ...
    for (int i = 0; i < sites.length; i++) {
      ...
      retval.append("        ")
          .append(XMLHandler.addTagValue("order", i));
      retval.append("        ").append(
          XMLHandler.addTagValue("name", sites[i]));
      retval.append("      </sites>").append(Const.CR);
    }
    ...
    for (int i = 0; i < lists.length; i++) {
      ...
      retval.append("        ")
          .append(XMLHandler.addTagValue("order", i));
      retval.append("        ").append(
          XMLHandler.addTagValue("name", lists[i]));
      retval.append("      </lists>").append(Const.CR);
    }
  ...
  public void loadXML(Node stepnode, List<DatabaseMeta> databases,
    ...
    try {
      ...
      for (int i = 0; i < k; i++) {
        fields[i] = XMLHandler
            .getNodeValue(XMLHandler.getSubNode(
                XMLHandler.getSubNodeByNr(stepnode, "field", i),
                "name"));
      }
      ...
      for (int i = 0; i < k; i++) {
        repositories[i] = XMLHandler.getNodeValue(XMLHandler
            .getSubNode(
                XMLHandler.getSubNodeByNr(stepnode, "repo", i),
                "name"));
      }
      ...
      for (int i = 0; i < k; i++) {
        sites[i] = XMLHandler
            .getNodeValue(XMLHandler.getSubNode(
                XMLHandler.getSubNodeByNr(stepnode, "sites", i),
                "name"));
      }
      ...
      for (int i = 0; i < k; i++) {
        lists[i] = XMLHandler
            .getNodeValue(XMLHandler.getSubNode(
                XMLHandler.getSubNodeByNr(stepnode, "lists", i),
                "name"));
      }
  ...
  public void setDefault() {
    ...
    urlField = BaseMessages.getString(PKG, "Template.FieldName.URL.Domain")
        + BaseMessages.getString(PKG, "Template.FieldName.URLBase");
    userField = "user";
  ...
  public void saveRep(Repository rep, ObjectId id_transformation,
    ...
    try {
      ...
      for (int i = 0; i < fieldOrder.length; i++) {
        rep.saveStepAttribute(id_transformation, id_step, i, "order", i);
